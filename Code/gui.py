...
connection = sqlite3.connect(r'C:\Users\ALKAN\PycharmProjects\pythonProject1\cardbms.db')
...
#def register():
    ...
    #cursor.execute('INSERT INTO Customer (customer_ID, name, address, customer_email, customer_password) VALUES (')
...
layoutLogo = [
    ...
    [sg.Image(filename=r'C:\Users\ALKAN\PycharmProjects\pythonProject1\logoR.png', size=(380,300))]
